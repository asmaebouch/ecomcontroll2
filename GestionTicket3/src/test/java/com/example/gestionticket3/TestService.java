...
import com.example.gestionticket3.Service.IService;
import com.example.gestionticket3.Service.ServiceImpl;
...
public class TestService {
    ...
    @BeforeAll
    static void init() {
        context = new AnnotationConfigApplicationContext(GestionTicket3Application.class);
    }
    @AfterAll
    static void close(){
    context.close();
